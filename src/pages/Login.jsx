        ...
        <div className="relative w-screen h-screen">
            ...
            <div className="absolute inset-0 bg-darkOverlay flex items-center justify-center p-4">
                <div className="w-800 md:w-375 p-4 bg-black shadow-2xl rounded-md backdrop-blur-md flex flex-col items-center justify-center">
                    <h1 className="font-bold text-ppink text-4xl mb-2 cursor-default"
                    >
                        Welcome to TuneUp
                    </h1>

                    <p className="text-ppink text-lg text-center mb-4 cursor-default">

                        
                    </p>

                    <img src={logo} alt="logo" className="w-full h-28 mb-20 object-contain" />
